...
public class CreateWebhookUseCase {
    ...
    public CreateWebhookUseCase(MerchantRepository merchants, ObjectMapper objectMapper, WebhookDeliveryRepository deliveries, PaymentRepository payments) {
    ...
    @Transactional
    public WebhookDelivery execute(String paymentId) {
